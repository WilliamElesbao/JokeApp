      ...
      <div className="bg-grid-white/[0.02] relative overflow-hidden rounded-md bg-black/[0.96] antialiased">
        <div className="w-full pt-20">
          <div className="flex h-full w-full flex-col items-center overflow-hidden rounded-md bg-transparent">
            ...
            <h1 className="relative z-20 text-center text-3xl font-bold text-white md:text-4xl">
              JokeApp
            </h1>

            <div className="relative h-[30rem] w-auto md:h-screen">
              {/* Gradients */}
              ...
              <SparklesCore
                ...
                maxSize={1}
                particleDensity={500}
                className="h-full w-full md:w-screen"
